...
public class CartItemResource {
    ...
    public ResponseEntity<Void> deleteCartItem(@PathVariable final Long id) {
        ...
        return ResponseEntity.noContent().build();// hoanf thanh nhieemh vuj và k có thong tin nào tra ve
        // vì xóa xong ròi thì cần j trả về đâu, trả về mã 204 là hiểu rôi(xóa thành công)
    }
